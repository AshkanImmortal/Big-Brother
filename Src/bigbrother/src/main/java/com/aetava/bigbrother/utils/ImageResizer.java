...
package com.aetava.bigbrother.utils;
...
import com.aetava.bigbrother.BuildConfig;

import java.io.FileDescriptor;
import java.io.FileNotFoundException;

/**
 * A simple subclass of {@link .utils.ImageWorker} that resizes images from resources given a target width
...
public class ImageResizer extends ImageWorker {
     ...
     * Decode and sample down a bitmap from a file to the requested width and height.
     *
     * @param fileuri The full path of the file to decode
     * @param reqWidth The requested width of the resulting bitmap
     * @param reqHeight The requested height of the resulting bitmap
     * @param cache The ImageCache used to find candidate bitmaps for use with inBitmap
     * @return A bitmap sampled down from the original with the same aspect ratio and dimensions
